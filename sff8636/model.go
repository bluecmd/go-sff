...
type Sff8636 struct {
	...
	LaserWavelenToler [2]byte             `json:"-"`                // 188 - Wavelength tolerance or Copper Cable Attenuation
...
func (s *Sff8636) StringCol() string {
	...
	result.WriteString(strCol("  Rx1 Power", fmt.Sprintf("%.4f mW", s.ChannelMonitoring.GetRxPower(1)), cyan, green))
	result.WriteString(strCol("  Rx2 Power", fmt.Sprintf("%.4f mW", s.ChannelMonitoring.GetRxPower(2)), cyan, green))
	result.WriteString(strCol("  Rx3 Power", fmt.Sprintf("%.4f mW", s.ChannelMonitoring.GetRxPower(3)), cyan, green))
	result.WriteString(strCol("  Rx4 Power", fmt.Sprintf("%.4f mW", s.ChannelMonitoring.GetRxPower(4)), cyan, green))
	result.WriteString(strCol("  Tx1 Bias", fmt.Sprintf("%.4f mA", s.ChannelMonitoring.GetTxBias(1)), cyan, green))
	result.WriteString(strCol("  Tx2 Bias", fmt.Sprintf("%.4f mA", s.ChannelMonitoring.GetTxBias(2)), cyan, green))
	result.WriteString(strCol("  Tx3 Bias", fmt.Sprintf("%.4f mA", s.ChannelMonitoring.GetTxBias(3)), cyan, green))
	result.WriteString(strCol("  Tx4 Bias", fmt.Sprintf("%.4f mA", s.ChannelMonitoring.GetTxBias(4)), cyan, green))
	result.WriteString(strCol("  Tx1 Power", fmt.Sprintf("%.4f mW", s.ChannelMonitoring.GetTxPower(1)), cyan, green))
	result.WriteString(strCol("  Tx2 Power", fmt.Sprintf("%.4f mW", s.ChannelMonitoring.GetTxPower(2)), cyan, green))
	result.WriteString(strCol("  Tx3 Power", fmt.Sprintf("%.4f mW", s.ChannelMonitoring.GetTxPower(3)), cyan, green))
	result.WriteString(strCol("  Tx4 Power", fmt.Sprintf("%.4f mW", s.ChannelMonitoring.GetTxPower(4)), cyan, green))
